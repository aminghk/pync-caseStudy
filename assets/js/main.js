...
/**
 * togglePopup function gets dom element and toggle class 'active' 
 */
function togglePopup() {
    document.getElementById("popup-1").classList.toggle("active")
}
/**
 * confetti animation player ** this code not using es6 features
 */
function confetti() {
   
    svgContainer.classList.remove('hide-confetti');
    animItem.goToAndPlay(0, true);
    
    console.log(animItem)
    animItem.addEventListener('complete', () => {
        svgContainer.classList.add('hide-confetti');
